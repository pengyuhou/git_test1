...
class MainMenu:
    ...
    def setup_background(self):
        self.background = set_up.GRAPHICS['level_1']
        ...
        self.viewport = set_up.SCREEN.get_rect()
        self.caption = tools.get_img(set_up.GRAPHICS['title_screen'],1,60,176,88,(255,0,220),C.BG_MULTI)

    def setup_player(self):
        self.player_image = tools.get_img(set_up.GRAPHICS['mario_bros'],178,32,12,16,(0,0,0),C.PLAYER_MULTI)

    def setup_cursor(self):
        self.cursor = pygame.sprite.Sprite()
        self.cursor.image = tools.get_img(set_up.GRAPHICS['item_objects'],24,160,8,8,(0,0,0),C.PLAYER_MULTI)
